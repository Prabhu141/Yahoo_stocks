...
def stocks(post_id):
    ...
    data = requests.get("https://query1.finance.yahoo.com/v7/finance/options/"+post_id, headers=headers).json()
...
# for el in calls:
#     print(el["regularMarketPrice"], el["regularMarketPreviousClose"], el["fiftyTwoWeekHigh"])
